...
#   males->same male, females->same female # todo could use tool to determine (or use dataset that has as label)
# plot of similarity, eer (speaker1=speaker2, speaker1!=speaker2)
# plot of wer (avg, stdv before/after conversion) # todo
...
# 1 data curation (todo)
# create hf dataset -> audio,gender,other metadata
# 2 analysis